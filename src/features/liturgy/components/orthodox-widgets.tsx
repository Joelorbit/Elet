...
const styles = StyleSheet.create({
  ...
  saintTitle: { fontSize: 16, fontWeight: "700", lineHeight: 21 },
  ...
  timeNumbers: { fontSize: 24, fontWeight: "700", lineHeight: 30 },
  ...
  streakTitle: { fontSize: 17, lineHeight: 22, fontWeight: "700", marginTop: 1 },
  ...
  nextActionTitle: { fontSize: 13, fontWeight: "700", marginTop: 1 },
  quickCheckButton: {
    flexDirection: "row",
    alignItems: "center",
    gap: 4,
  ...
  quickCheckText: { color: "#FFFFFF", fontSize: 12, fontWeight: "700" },
  penanceList: { gap: 6 },
